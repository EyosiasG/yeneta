...
final class Color
{
    ...
    public const color1 _50 = '#f0fdfa';

    public const color1 _100 = '#ccfbf1';

    public const color1 _200 = '#99f6e4';

    public const color1 _300 = '#5eead4';

    public const color1 _400 = '#2dd4bf';

    public const color1 _500 = '#14b8a6';

    public const color1 _600 = '#0d9488';

    public const color1 _700 = '#0f766e';

    public const color1 _800 = '#115e59';

    public const color1 _900 = '#134e4a';
